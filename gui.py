...
class Window(Frame):
    def __init__(self, master=None):
        ...
        self.b2 = Button(text="Upload Image", height="2", width="40", command = self.uploadImage).pack()
        self.b2 = Button(text="Color Image", height="2", width="40", command = self.color).pack()
